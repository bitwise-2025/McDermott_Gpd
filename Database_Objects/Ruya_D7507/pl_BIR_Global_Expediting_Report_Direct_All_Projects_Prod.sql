CREATE TABLE [epr].[BIR_Global_Expediting_Report_Direct_All_Projects]
(
...
SET @Date = GETDATE();
SET @v_pipelinename='pl_BIR_Global_Expediting_Report_Direct_All_Projects'
...
INSERT INTO [dbo].[plp_parameter_value] ([parameter_code],[parameter_value],[active],[touched_by],[touched_dtm],[pipeline_code],[pipeline_sub_code])
     VALUES('table_name','BIR_Global_Expediting_Report_Direct_All_Projects',1,'sundararaju.batta@mcdermott.com',@Date,@v_pipelinename,'NetworkFolder')
INSERT INTO [dbo].[plp_parameter_value] ([parameter_code],[parameter_value],[active],[touched_by],[touched_dtm],[pipeline_code],[pipeline_sub_code])
