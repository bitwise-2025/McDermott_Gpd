/****** Object:  StoredProcedure [dbo].[generic_json_validator]    Script Date: 1/31/2023 12:03:23 PM ******/
SET ANSI_NULLS ON
GO
...
Alter PROC [dbo].[generic_json_validator] @p_load_name [varchar](40),@p_debug_flag [varchar](1),@p_delete_source_when_no_errors_flag [varchar](1),@p_error_id [int] OUT,@p_error_message [varchar](1000) OUT AS 
