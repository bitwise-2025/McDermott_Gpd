...
GO
create PROC [dbo].[usp_fact_fss_businessline_updates_load_mb] @sheetname [varchar](100) AS
BEGIN
  ...
  if @sheetname='7) Revenue'
	Begin
		declare @reportingperiod_revenue_mb date

		select @datetimekey=max(zCreatedDateTime) from fss.[stage_fss_revenue_mb_v]

if exists (select * from fss.Stage_fss_reportingperiod_mb_V where  [Data source]='Revenue MB' and month([Reporting Period]) not between 0 and 12)
    BEGIN
        set @Errormessage='Invalid Month Range'
        select @Errormessage
    End

set @reportingperiod_revenue_mb =(select distinct [Reporting Period] from fss.Stage_fss_reportingperiod_mb_V where [Data source]='Revenue MB')
...
'Revenue MB' as [Data Source],null as [New/ CO],[JV/Non-JV],[BL/PW] as BLPW,[External Product Line],[Customer],null as [Seq No],null as [Sub Title],null as [Caclulation],
null as [Category],null as [Facility],null as [Commentary],@reportingperiod_revenue_mb as TransactionDate,null AS [Quarter],
case when datasubclass_up in ( 'Jan Q Latest Update HYP','Jan Q Latest Update ADJ','Jan Q Latest Update') then 1
     when datasubclass_up in ( 'Feb Q Latest Update HYP','Feb Q Latest Update ADJ','Feb Q Latest Update')then 2
	 when datasubclass_up in ( 'Mar Q Latest Update HYP','Mar Q Latest Update ADJ','Mar Q Latest Update') then 3 
	 when datasubclass_up in ( 'Apr Q Latest Update HYP','Apr Q Latest Update ADJ','Apr Q Latest Update') then 4
	 when datasubclass_up in ( 'May Q Latest Update HYP','May Q Latest Update ADJ','May Q Latest Update') then 5 
	 when datasubclass_up in ( 'Jun Q Latest Update HYP','Jun Q Latest Update ADJ','Jun Q Latest Update') then 6 
	 when datasubclass_up in ( 'Jul Q Latest Update HYP','Jul Q Latest Update ADJ','Jul Q Latest Update') then 7 
	 when datasubclass_up in ( 'Aug Q Latest Update HYP','Aug Q Latest Update ADJ','Aug Q Latest Update') then 8 
	 when datasubclass_up in ( 'Sep Q Latest Update HYP','Sep Q Latest Update ADJ','Sep Q Latest Update') then 9 
	 when datasubclass_up in ( 'Oct Q Latest Update HYP','Oct Q Latest Update ADJ','Oct Q Latest Update') then 10
	 when datasubclass_up in ( 'Nov Q Latest Update HYP','Nov Q Latest Update ADJ','Nov Q Latest Update') then 11
	 when datasubclass_up in ( 'Dec Q Latest Update HYP','Dec Q Latest Update ADJ','Dec Q Latest Update') then 12
	 
	 else 0 end as month
,amount,getdate() as created_date_time
from 
(
select [#],[Business Line],[External Product Line1],[Project No.],[JV/Non-JV],[BL/PW],[External Product Line],[Project Title],[Customer],amount, datasubclass_up,

case when datasubclass_up in ('Jan Q Latest Update HYP','Feb Q Latest Update HYP','Mar Q Latest Update HYP','Apr Q Latest Update HYP','May Q Latest Update HYP',
'Jun Q Latest Update HYP','Jul Q Latest Update HYP','Aug Q Latest Update HYP','Sep Q Latest Update HYP','Oct Q Latest Update HYP'
,'Nov Q Latest Update HYP','Dec Q Latest Update HYP') then 'Curr Qtr Update HYP'

	 when datasubclass_up in ('Jan Q Latest Update ADJ','Feb Q Latest Update ADJ','Mar Q Latest Update ADJ','Apr Q Latest Update ADJ','May Q Latest Update ADJ',
'Jun Q Latest Update ADJ','Jul Q Latest Update ADJ','Aug Q Latest Update ADJ','Sep Q Latest Update ADJ','Oct Q Latest Update ADJ','Nov Q Latest Update ADJ',
'Dec Q Latest Update ADJ') then 'Curr Qtr Update ADJ'

	 when datasubclass_up in ('Jan Q Latest Update','Feb Q Latest Update','Mar Q Latest Update','Apr Q Latest Update','May Q Latest Update','Jun Q Latest Update',
...
,isnull([External Product Line1],'') as [External Product Line1]
,isnull([Project No.],'') as [Project No.]
,isnull([JV/Non-JV],'') as [JV/Non-JV]
,isnull([BL/PW],'') as [BL/PW]
,isnull([External Product Line],'') as [External Product Line]
...
,isnull([Q3MB],'') as [Q3MB]
,isnull([Q4MB],'') as [Q4MB]
,isnull([TotalMB],'') as [TotalMB]
,isnull([X4],'') as [X4]
,isnull([Q1F2],'') as [Q1F2]
,isnull([Q2F2],'') as [Q2F2]
,isnull([Q3F2],'') as [Q3F2]
,isnull([Q4F2],'') as [Q4F2]
,isnull([TotalF2],'') as [TotalF2]
,isnull([X5],'') as [X5]
,isnull([X6],'') as [X6]
,isnull([X7],'') as [X7]
,isnull([X8],'') as [X8]
...
from [fss].[stage_fss_revenue_mb_v]
...
(
[Jan Q Latest Update HYP],[Feb Q Latest Update HYP],[Mar Q Latest Update HYP],[Apr Q Latest Update HYP],[May Q Latest Update HYP],[Jun Q Latest Update HYP]
,[Jul Q Latest Update HYP],[Aug Q Latest Update HYP],[Sep Q Latest Update HYP],[Oct Q Latest Update HYP],[Nov Q Latest Update HYP],[Dec Q Latest Update HYP]
,[Total  Q Latest Update HYP],[Jan Q Latest Update ADJ],[Feb Q Latest Update ADJ],[Mar Q Latest Update ADJ],[Apr Q Latest Update ADJ],[May Q Latest Update ADJ]
,[Jun Q Latest Update ADJ],[Jul Q Latest Update ADJ],[Aug Q Latest Update ADJ],[Sep Q Latest Update ADJ],[Oct Q Latest Update ADJ],[Nov Q Latest Update ADJ]
,[Dec Q Latest Update ADJ],[Total  Q Latest Update ADJ],[Jan Q Latest Update],[Feb Q Latest Update],[Mar Q Latest Update],[Apr Q Latest Update],[May Q Latest Update]
...
,[Total  Q Latest Update]
,[Q1MB],[Q2MB],[Q3MB],[Q4MB],[TotalMB],[Q1F2],[Q2F2],[Q3F2],[Q4F2],[TotalF2],[Q1 MB Prev],[Q2 MB Prev],[Q3 MB Prev],[Q4 MB Prev]
,[Total MB Prev]
)
) as unpvt
	...
	and  data_sub_class_name in ('Curr Qtr Update HYP','Curr Qtr Update ADJ','Curr Qtr Update','Q1F2','Q2F2','Q3F2','Q4F2','Q1 MB Prev','Q2 MB Prev','Q3 MB Prev','Q4 MB Prev')
