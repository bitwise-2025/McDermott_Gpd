...
create VIEW [dbo].[fact_fss_Revenue_updates_v] AS SELECT [dim_entp_fss_business_line_nk]
...
SELECT [dim_entp_fss_business_line_nk]
	...
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn 
	FROM fact_fss_Revenue_curr_qtr_update_hyp_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM fact_fss_Revenue_curr_qtr_update_adj_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_Revenue_curr_qtr_update_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_Revenue_MB_Amount_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_Revenue_F2_Amount_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_Revenue_Total_Prev_Qtr_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_Revenue_Total_Current_Qtr_update_v
