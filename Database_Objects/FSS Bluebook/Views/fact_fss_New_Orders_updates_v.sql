/****** Object:  View [dbo].[fact_fss_New_Orders_updates_v]    Script Date: 10/27/2023 1:31:51 PM ******/
SET ANSI_NULLS ON
GO
...
Create VIEW [dbo].[fact_fss_New_Orders_updates_v] AS SELECT [dim_entp_fss_business_line_nk]
...
SELECT [dim_entp_fss_business_line_nk]
	...
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn 
	FROM fact_fss_New_Orders_curr_qtr_update_hyp_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM fact_fss_New_Orders_curr_qtr_update_adj_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_New_Orders_curr_qtr_update_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_New_Orders_MB_Amount_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_New_Orders_F2_Amount_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_New_Orders_Total_Prev_Qtr_update_v
...
SELECT  [dim_entp_fss_business_line_nk]
	...
	,datasubclass
	,fact_fss_businessline_update_v1_dr
	,fact_fss_businessline_update_v2_rn FROM  fact_fss_New_Orders_Total_Current_Qtr_update_v
