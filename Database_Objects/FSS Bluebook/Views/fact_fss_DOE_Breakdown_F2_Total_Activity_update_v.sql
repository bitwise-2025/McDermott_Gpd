...
create VIEW [dbo].[fact_fss_DOE_Breakdown_F2_Total_Activity_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='F2 Total Activity';
GO