...
CREATE VIEW [dbo].[fact_fss_businessline_updates_v2]
AS select 
  dim_ent_source_nk, 
  ...
  Created_date_time,
  temp_hash_key,
	dense_rank() over(partition by temp_hash_key, Datasource,[month], TransactionDate order by Created_date_time desc ) as fact_fss_businessline_update_v1_dr
