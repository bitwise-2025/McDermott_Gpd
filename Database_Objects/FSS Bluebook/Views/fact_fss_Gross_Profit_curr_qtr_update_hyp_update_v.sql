/****** Object:  View [dbo].[fact_fss_New_Orders_update_v]    Script Date: 10/20/2023 1:46:40 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[fact_fss_Gross_Profit_curr_qtr_update_hyp_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'Gross Profit' and C.data_Sub_Class_name ='Curr Qtr Update HYP';
GO
