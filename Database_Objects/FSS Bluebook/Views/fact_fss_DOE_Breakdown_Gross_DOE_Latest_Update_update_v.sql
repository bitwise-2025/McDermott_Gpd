...
Create VIEW [dbo].[fact_fss_DOE_Breakdown_Gross_DOE_Latest_Update_update_v] AS SELECT 
      ...
      ,[Amount] AS [Gross DOE Latest Update]
      ,V.[created_date_time]
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='Gross DOE Latest Update';
GO
