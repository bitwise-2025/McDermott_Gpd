...
Create VIEW [dbo].[fact_fss_DOE_Breakdown_MB_Total_Activity_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='MB Total Activity';
GO