...
Create VIEW [dbo].[fact_fss_PnL_YTD_To_Go_Latest_Update_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'P&L YTD' and C.data_Sub_Class_name ='To-Go Latest Update';
GO
