...
CREATE VIEW [dbo].[fact_fss_Functional_Support_Cost_curr_qtr_update_adj_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'Functional Support Cost' and C.data_Sub_Class_name ='Curr Qtr Update ADJ';
GO
