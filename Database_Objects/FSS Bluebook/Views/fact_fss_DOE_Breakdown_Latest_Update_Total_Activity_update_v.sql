...
Create VIEW [dbo].[fact_fss_DOE_Breakdown_Latest_Update_Total_Activity_update_v] AS SELECT 
      ...
      ,[Amount] AS [Latest Update Total Activity]
      ,V.[created_date_time]
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='Latest Update Total Activity';
GO
