/****** Object:  StoredProcedure [dbo].[usp_fss_dim_load_business_line]    Script Date: 3/28/2024 1:05:47 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[usp_fss_dim_load_business_line] AS
BEGIN
	BEGIN TRY
		SET NOCOUNT ON
		...
		EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_fss_business_line','Y','N','Y'
