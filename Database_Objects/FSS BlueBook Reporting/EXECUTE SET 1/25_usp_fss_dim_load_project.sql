/****** Object:  StoredProcedure [dbo].[usp_fss_dim_load_project]    Script Date: 3/28/2024 1:04:34 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[usp_fss_dim_load_project] AS
BEGIN
	BEGIN TRY
		SET NOCOUNT ON
