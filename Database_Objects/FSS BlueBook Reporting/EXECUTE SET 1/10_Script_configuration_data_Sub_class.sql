...
IF NOT EXISTS(SELECT * from dim_ent_data_sub_class  WHERE data_sub_class_name ='Q1 MB')
...
(@subclassnk ,'1900-12-30 00:00:00.000',    '2050-12-30 00:00:00.000',       'Q1 MB',

1,     @Datetime,  NULL,  'N',   @dataclassnk,     'Amount',       'Q1 MB','Q1 MB',NULL)

END

IF NOT EXISTS(SELECT * from dim_ent_data_sub_class  WHERE data_sub_class_name ='Q2 MB')
...
(@subclassnk ,'1900-12-30 00:00:00.000',    '2050-12-30 00:00:00.000',       'Q2 MB',

1,     @Datetime,  NULL,  'N',   @dataclassnk,     'Amount',       'Q2 MB','Q2 MB',NULL)

END

IF NOT EXISTS(SELECT * from dim_ent_data_sub_class  WHERE data_sub_class_name ='Q3 MB')
...
(@subclassnk ,'1900-12-30 00:00:00.000',    '2050-12-30 00:00:00.000',       'Q3 MB',

1,     @Datetime,  NULL,  'N',   @dataclassnk,     'Amount',       'Q3 MB','Q3 MB',NULL)

END

IF NOT EXISTS(SELECT * from dim_ent_data_sub_class  WHERE data_sub_class_name ='Q4 MB')
...
(@subclassnk ,'1900-12-30 00:00:00.000',    '2050-12-30 00:00:00.000',       'Q4 MB',

1,     @Datetime,  NULL,  'N',   @dataclassnk,     'Amount',       'Q4 MB','Q4 MB',NULL)
