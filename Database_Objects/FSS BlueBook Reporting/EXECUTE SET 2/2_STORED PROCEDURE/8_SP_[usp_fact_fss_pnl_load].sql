/****** Object:  StoredProcedure [dbo].[usp_fact_fss_pnl_load]    Script Date: 3/12/2024 5:57:39 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROC [dbo].[usp_fact_fss_pnl_load] AS
BEGIN
   DECLARE  @Errormessage varchar(max)
   DECLARE  @datetimekey datetime

    declare @reportingperiod_pandl date
              if exists (select 1 from fss.Stage_fss_reportingperiod_V where month([Reporting Period]) not between 0 and 12)
                     BEGIN
                           ...
                           select @Errormessage
                     End
              set @reportingperiod_pandl =(select distinct [Reporting Period] from fss.Stage_fss_reportingperiod_V where [Data source]='P&L')
			  select @datetimekey=max(zCreatedDateTime) from fss.stage_fss_PandL_V

if (month(@reportingperiod_pandl) between 1 and 3)
...
'P&L' as [Data Source],null as [New/ CO],null as [JV/Non-JV],null as [BL/PW],null as [External Product Line],null as [Customer],
[Seq No],[Sub Title],[Calculation],[Category],null as [Facility], [Commentary],@reportingperiod_pandl as TransactionDate,'Q1' as [Quarter],
...
from [fss].[stage_fss_PandL_V] WHERE [zCreatedDateTime] = @datetimekey and isnull(Category,'')<>'' and isnull([Business Line],'')<>''
...
if (month(@reportingperiod_pandl) between 4 and 6)
...
d.dim_ent_data_class_nk,d.dim_ent_data_sub_class_nk,[dim_entp_fss_business_line_nk],
'P&L' as [Data Source],null as [New/ CO],null as [JV/Non-JV],null as [BL/PW],null as [External Product Line],null as [Customer],
[Seq No],[Sub Title],[Calculation],[Category],null as [Facility], [Commentary],@reportingperiod_pandl as TransactionDate,'Q2' as [Quarter],
...
if (month(@reportingperiod_pandl) between 7 and 9)
...
d.dim_ent_data_class_nk,d.dim_ent_data_sub_class_nk,[dim_entp_fss_business_line_nk],
'P&L' as [Data Source],null as [New/ CO],null as [JV/Non-JV],null as [BL/PW],null as [External Product Line],null as [Customer],
[Seq No],[Sub Title],[Calculation],[Category],null as [Facility], [Commentary],@reportingperiod_pandl as TransactionDate,'Q3' as [Quarter],
...
if (month(@reportingperiod_pandl) between 10 and 12)
...
d.dim_ent_data_class_nk,d.dim_ent_data_sub_class_nk,[dim_entp_fss_business_line_nk],
'P&L' as [Data Source],null as [New/ CO],null as [JV/Non-JV],null as [BL/PW],null as [External Product Line],null as [Customer],
[Seq No],[Sub Title],[Calculation],[Category],null as [Facility], [Commentary],@reportingperiod_pandl as TransactionDate,'Q4' as [Quarter],
