...
Create VIEW  [dbo].[fact_fss_DOE_Breakdown_Actual_Productivity_PF_QTD_update_v] AS SELECT 
      ...
      ,[Amount] AS [Actual Productivity (PF) QTD]
      ,V.[created_date_time]
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='Actual Productivity (PF) QTD';
GO