...
Create VIEW [dbo].[fact_fss_DOE_Breakdown_Std_MB_Total_Activity_update_v] AS SELECT 
      ...
      ,[Amount] AS [Std MB Total Activity]
      ,V.[created_date_time]
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='Std MB Total Activity';
GO