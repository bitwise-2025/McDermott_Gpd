...
Create VIEW [dbo].[fact_fss_Capex_n_DD_Curr_Qtr_Update_update_v] AS SELECT 
      ...
      ,[TransactionDate]
      ,[Quarter]
       ,case when [month]=0 then 'Total' else substring(DateName( month , DateAdd( month , [month] , -1 ) ),1,3) end AS [Month]
  ...
  WHERE V.dataSource= 'Capex & DD' and C.data_Sub_Class_name ='Curr Qtr Update';
GO
