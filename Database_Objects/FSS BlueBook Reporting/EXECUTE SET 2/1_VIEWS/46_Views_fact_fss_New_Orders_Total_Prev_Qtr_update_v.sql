...
drop view fact_fss_New_Orders_Total_Prev_Qtr_update_v
go
Create VIEW [dbo].[fact_fss_New_Orders_Total_Prev_Qtr_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'New Orders' and C.data_Sub_Class_name ='Total  Prev Qtr';
