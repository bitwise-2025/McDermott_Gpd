/****** Object:  View [dbo].[fact_fss_PnL_mb_update_v]    Script Date: 10/20/2023 1:47:59 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[fact_fss_PnL_mb_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'P&L' and C.data_Sub_Class_name ='MB Amount';
GO
