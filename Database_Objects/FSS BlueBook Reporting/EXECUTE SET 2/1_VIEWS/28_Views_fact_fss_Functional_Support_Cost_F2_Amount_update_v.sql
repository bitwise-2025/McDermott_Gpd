...
CREATE VIEW [dbo].[fact_fss_Functional_Support_Cost_F2_Amount_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'Functional Support Cost' and C.data_Sub_Class_name ='F2 Amount';
GO
