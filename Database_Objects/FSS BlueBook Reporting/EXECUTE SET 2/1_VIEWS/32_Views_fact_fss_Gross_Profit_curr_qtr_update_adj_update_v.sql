...
CREATE VIEW [dbo].[fact_fss_Gross_Profit_curr_qtr_update_adj_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'Gross Profit' and C.data_Sub_Class_name ='Curr Qtr Update ADJ';
GO
