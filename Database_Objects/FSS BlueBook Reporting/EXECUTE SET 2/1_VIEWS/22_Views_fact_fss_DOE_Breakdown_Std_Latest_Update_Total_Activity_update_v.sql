...
Create VIEW [dbo].[fact_fss_DOE_Breakdown_Std_Latest_Update_Total_Activity_update_v] AS SELECT 
      ...
      ,[Amount] AS [Std Latest Update Total Activity]
      ,V.[created_date_time]
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='Std Latest Update Total Activity';
GO