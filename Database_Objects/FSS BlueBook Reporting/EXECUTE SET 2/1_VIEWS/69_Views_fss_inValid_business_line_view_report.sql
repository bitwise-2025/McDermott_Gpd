...
if object_id('fss.stage_fss_doe_breakdown_valid_businessline_report_vw','v') is not null
drop view fss.stage_fss_doe_breakdown_valid_businessline_report_vw;
go
CREATE VIEW fss.stage_fss_doe_breakdown_valid_businessline_report_vw
AS
select O.* from fss.stage_fss_doe_breakdown_report_v O 
INNER JOIN dim_entp_fss_business_line B
ON O.[Business Line]=B.business_line
GO
...
/*
mdrdeventerpriseanalyticssql.database.windows.net
[MDR-DEV-EntAnalytics-SynapseSQLPool01]
*/