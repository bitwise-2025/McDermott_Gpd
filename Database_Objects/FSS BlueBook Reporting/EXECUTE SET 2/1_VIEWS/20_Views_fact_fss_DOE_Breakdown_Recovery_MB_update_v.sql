...
Create VIEW [dbo].[fact_fss_DOE_Breakdown_Recovery_MB_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='Recovery MB';
GO
