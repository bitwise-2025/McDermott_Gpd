/****** Object:  View [dbo].[fact_fss_PnL_forecast_update_v]    Script Date: 10/20/2023 1:46:40 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[fact_fss_PnL_forecast_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'P&L' and C.data_Sub_Class_name ='F2 Amount';
GO
