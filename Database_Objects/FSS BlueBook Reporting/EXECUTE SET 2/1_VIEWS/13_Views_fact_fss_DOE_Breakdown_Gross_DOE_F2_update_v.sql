...
Create VIEW [dbo].[fact_fss_DOE_Breakdown_Gross_DOE_F2_update_v] AS SELECT 
  ...
  WHERE V.dataSource= 'DOE Breakdown' and C.data_Sub_Class_name ='Gross DOE F2';
GO
