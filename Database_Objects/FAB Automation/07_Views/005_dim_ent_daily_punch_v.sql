DROP VIEW [dbo].[dim_ent_daily_punch_v]
GO

CREATE VIEW [dbo].[dim_ent_daily_punch_v] AS select ts_date,person_no_external,punch_in,punch_out,dim_ent_fab_rota_sk,run_timestamp,
case when
	(case when 
