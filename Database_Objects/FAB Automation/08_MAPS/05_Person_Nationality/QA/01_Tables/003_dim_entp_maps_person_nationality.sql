...
CREATE TABLE [dbo].[dim_entp_maps_person_nationality]
(
	[dim_entp_maps_person_nationality_sk] 		[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_person_nationality_nk] 		[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_person_nationality_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_person_nationality_sk] ASC
	) NOT ENFORCED 
)
WITH
(
