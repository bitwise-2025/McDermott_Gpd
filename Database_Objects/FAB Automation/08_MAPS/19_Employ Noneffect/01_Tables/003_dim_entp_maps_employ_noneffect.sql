CREATE TABLE [dbo].[dim_entp_maps_employ_noneffect]
(
	[dim_entp_maps_employ_noneffect_sk] 			[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_employ_noneffect_nk] 			[bigint] NOT NULL,
	...
	[dim_entp_maps_reasons_nk]						[int] null,
	
 CONSTRAINT [Constr_dim_entp_maps_employ_noneffect_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_employ_noneffect_sk] ASC
	) NOT ENFORCED 
)
WITH
(
