CREATE TABLE [dbo].[dim_entp_maps_post_location]
(
	[dim_entp_maps_post_location_sk] 			[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_post_location_nk] 			[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_post_location_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_post_location_sk] ASC
	) NOT ENFORCED 
)
WITH
(
