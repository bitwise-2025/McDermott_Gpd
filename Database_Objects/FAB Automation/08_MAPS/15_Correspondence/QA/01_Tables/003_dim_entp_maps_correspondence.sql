CREATE TABLE [dbo].[dim_entp_maps_correspondence]
(
	[dim_entp_maps_correspondence_sk] 		[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_correspondence_nk] 		[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_correspondence_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_correspondence_sk] ASC
	) NOT ENFORCED 
)
WITH
(
