...
CREATE TABLE [dbo].[dim_entp_maps_employee_skill]
(
	[dim_entp_maps_employee_skill_sk] 			[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_employee_skill_nk] 			[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_employee_skill_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_employee_skill_sk] ASC
	) NOT ENFORCED 
)
WITH
(
