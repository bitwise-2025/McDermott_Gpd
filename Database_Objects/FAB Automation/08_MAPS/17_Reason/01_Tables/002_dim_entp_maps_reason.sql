...
CREATE TABLE [dbo].[dim_entp_maps_reason]
(
	[dim_entp_maps_reason_sk] 			[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_reason_nk] 			[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_reason_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_reason_sk] ASC
	) NOT ENFORCED 
)
WITH
(
