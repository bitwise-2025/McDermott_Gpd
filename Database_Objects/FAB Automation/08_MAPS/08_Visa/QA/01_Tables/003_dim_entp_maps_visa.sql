CREATE TABLE [dbo].[dim_entp_maps_visa]
(
	[dim_entp_maps_visa_sk] 					[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_visa_nk] 					[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_visa_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_visa_sk] ASC
	) NOT ENFORCED 
)
WITH
(
