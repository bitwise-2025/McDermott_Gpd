CREATE TABLE [dbo].[dim_entp_maps_org_name_history]
(
	[dim_entp_maps_org_name_history_sk] 			[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_org_name_history_nk] 			[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_org_name_history_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_org_name_history_sk] ASC
	) NOT ENFORCED 
)
WITH
(
