...
CREATE TABLE [dbo].[dim_entp_maps_passport]
(
	[dim_entp_maps_passport_sk] 			[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_passport_nk] 			[bigint] NOT NULL,
 ...
 CONSTRAINT [Constr_dim_entp_maps_passport_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_passport_sk] ASC
	) NOT ENFORCED 
)
WITH
(
