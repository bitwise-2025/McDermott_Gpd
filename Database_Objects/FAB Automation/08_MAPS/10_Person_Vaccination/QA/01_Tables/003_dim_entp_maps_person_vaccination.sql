CREATE TABLE [dbo].[dim_entp_maps_person_vaccination]
(
	[dim_entp_maps_person_vaccination_sk] 		[bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_maps_person_vaccination_nk] 		[bigint] NOT NULL,
	...
	[dim_entp_maps_vaccination_nk]				[int] null,		
	
 CONSTRAINT [Constr_dim_entp_maps_person_vaccination_sk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_maps_person_vaccination_sk] ASC
	) NOT ENFORCED 
)
WITH
(
