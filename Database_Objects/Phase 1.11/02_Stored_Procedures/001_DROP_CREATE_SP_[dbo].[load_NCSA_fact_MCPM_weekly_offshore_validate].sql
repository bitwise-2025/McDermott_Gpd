/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_weekly_offshore_validate]    Script Date: 12/13/2022 5:49:12 PM ******/
DROP PROCEDURE [dbo].[load_NCSA_fact_MCPM_weekly_offshore_validate]
GO
...
COALESCE(b.ident2_description, '') as ident2_description,
