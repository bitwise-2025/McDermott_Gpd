/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_ProgressItem_fact_load_sat_WI1300]    Script Date: 9/23/2022 4:37:30 AM ******/
DROP PROCEDURE [dbo].[load_NCSA_fact_MCPM_ProgressItem_fact_load]
GO
...
CREATE PROC [dbo].[load_NCSA_fact_MCPM_ProgressItem_fact_load] AS
...
07/01/2021 - Satish: Adding FACT load for Earned Quantity and Earned Hours
07/12/2021 - Satish: Adding FACT load for VarianceActualHrs and VarianceActualAmt
09/19/2022 - Satish: Changing the Data_sub_class and adding more FACT entries sk/nk
*/
		...
		transaction_date,transaction_quantity,created_date_time,dim_ent_jde_coa_sk,dim_ent_jde_coa_nk)
		select dim_ent_function_sk,
			   ...
			   load_date_time,
			   dim_ent_jde_coa_sk,dim_ent_jde_coa_nk
...
--09/19/2022 - Satish: Adding more FACT entries.
...
---------------------------------------
	...
	--truncate table [gpd].[NCSA_MCPM_ProgressItems_Onshore]
