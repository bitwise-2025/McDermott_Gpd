...
--add goldenpass project number to mcpm dimensions,weekly,monthly
...
--------------------------------------------------debi scripts----------------------------------------
insert into plp_parameter_value values('databaseName','Sitepro_bb3',1,'ssampathkumar@mcdermott.com','2021-12-07 07:52:41.387','pl_6wklookahead_sitepro_source_to_stage','Sitepro');

--Insert statement for plp_parameter_value by using Insert select 
insert into plp_parameter_value
select parameter_code,parameter_value,active,touched_by,'2021-12-07 07:52:41.387' AS touched_dtm,
