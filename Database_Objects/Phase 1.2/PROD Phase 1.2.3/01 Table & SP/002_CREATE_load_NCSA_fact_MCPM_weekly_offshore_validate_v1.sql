/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_weekly_offshore_validate]    Script Date: 10/6/2022 7:50:37 AM ******/
...
COALESCE(b.ident2_description, '') as ident3_description,
...
ISNULL(PSRLevel1,NULL) as PSRLevel1,
ISNULL(PSRLevel2,NULL) as PSRLevel2,
ISNULL(PSRL1Description,NULL) as PSRL1Description,
ISNULL(PSRL2Description,NULL) as PSRL2Description,
