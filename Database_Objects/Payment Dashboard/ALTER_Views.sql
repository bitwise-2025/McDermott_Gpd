ALTER VIEW [rpy].[Expenditure_Types_v] AS SELECT [ATTRIBUTE1]
      ,[ATTRIBUTE10]
      ,[ATTRIBUTE11]
      ,[ATTRIBUTE12]
      ,[ATTRIBUTE13]
...
AS SELECT a.[CODE_COMBINATION_ID]
...
ALTER VIEW [rpy].[Invoice_distributions_ap_invoice_distributions_all_v] AS SELECT Cast([ACCOUNTING_DATE] as date) as [ACCOUNTING_DATE]
      ,[ACCOUNTING_EVENT_ID]
      ,[ADJUSTMENT_REASON]
...
ALTER VIEW [rpy].[Invoice_header_ap_invoices_all_v] AS SELECT a.[INVOICE_ID]
      ,a.[LAST_UPDATE_DATE]
      ,[LAST_UPDATED_BY]
      ,[VENDOR_ID]
      ,[INVOICE_NUM]
...
ALTER VIEW [rpy].[Invoice_line_ap_invoice_lines_all_v] AS SELECT Cast([ACCOUNTING_DATE] as date) as [ACCOUNTING_DATE]
      ,[ACCOUNT_SEGMENT]
      ,[ACC_REFERENCE_VALUE1]
      ,[ADJUSTMENT_REASON]
      ,CAST([AMOUNT] as decimal(38, 10)) as [AMOUNT]
...
ALTER VIEW [rpy].[Invoice_payment_schedules_v] AS SELECT CAST([AMOUNT_REMAINING] as decimal(38, 10)) as [AMOUNT_REMAINING]
      ,[APR_DISCOUNT_RATE]
...
ALTER VIEW [rpy].[Invoice_Payments_v] AS SELECT Cast([ACCOUNTING_DATE] as date) as [ACCOUNTING_DATE]
      ,[ACCOUNTING_EVENT_ID]
      ,[ACCTS_PAY_CODE_COMBINATION_ID]
      ,CAST([AMOUNT] as decimal(38, 10)) as [AMOUNT]
...
ALTER VIEW [rpy].[Payment_Details_v] AS SELECT Cast([ACTUAL_VALUE_DATE] as date) as [ACTUAL_VALUE_DATE]
      ,[ADDRESS_LINE1]
      ,[ADDRESS_LINE2]
      ,[ADDRESS_LINE3]
      ,[ADDRESS_LINE4]
...
ALTER VIEW [rpy].[Payment_History_v] AS SELECT Cast([ACCOUNTING_DATE] as date) as [ACCOUNTING_DATE]
      ,[ACCOUNTING_EVENT_ID]
      ,[BANK_CURRENCY_CODE]
      ,[BANK_TO_BASE_XRATE]
...
ALTER VIEW [rpy].[Prepayment_Application_Distribution_v] AS SELECT [ACCOUNTING_EVENT_ID]
      ,CAST([AMOUNT] as decimal(38, 10)) as [AMOUNT]
      ,CAST([AMOUNT_VARIANCE] as decimal(38, 10)) as [AMOUNT_VARIANCE]
      ,[AWT_RELATED_ID]
      ,CAST([BASE_AMOUNT] as decimal(38, 10)) as [BASE_AMOUNT]
...
ALTER VIEW [rpy].[Prepayment_History_v] AS SELECT Cast([ACCOUNTING_DATE] as date) as [ACCOUNTING_DATE]
      ,[ACCOUNTING_EVENT_ID]
      ,[BC_EVENT_ID]
      ,[CREATED_BY]
      ,Cast([CREATION_DATE] as date) as [CREATION_DATE]
...
ALTER VIEW [rpy].[Project_Elements_Data_v] AS SELECT [ATTRIBUTE1]
      ,[ATTRIBUTE10]
      ,[ATTRIBUTE11]
      ,[ATTRIBUTE12]
      ,[ATTRIBUTE13]
...
ALTER VIEW [rpy].[Projects_Data_v] AS SELECT [ATTRIBUTE1]
      ,[ATTRIBUTE10]
...
ALTER VIEW [rpy].[Supplier_Site_Data_v] AS SELECT [ADDRESS1]
      ,[ADDRESS2]
      ,[ADDRESS3]
      ,[ADDRESS4]
      ,[CITY]
