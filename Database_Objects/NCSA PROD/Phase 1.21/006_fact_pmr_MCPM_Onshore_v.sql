ALTER VIEW [dbo].[fact_pmr_MCPM_Onshore_v] AS 
select  
fact_entp_sk
...
(select [dim_entp_project_nk],[dim_entp_discipline_nk],dim_entp_data_class_nk,[dim_entp_data_sub_class_nk],dim_entp_source_nk,[dim_entp_sub_source_nk],[transaction_date],
...
group by[dim_entp_project_nk],[dim_entp_discipline_nk],dim_entp_data_class_nk,[dim_entp_data_sub_class_nk],dim_entp_source_nk,[dim_entp_sub_source_nk],[transaction_date]) g
where k.dim_entp_project_nk  = g.dim_entp_project_nk
and k.dim_entp_discipline_nk  = g.dim_entp_discipline_nk
