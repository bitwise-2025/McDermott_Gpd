/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_Legacy_Onshore_validate]    Script Date: 7/18/2024 8:15:31 PM ******/
...
-----------------------------------------------------------------------------------------------------*/
	...
	UPDATE [gpd].[NCSA_MCPM_Legacy]
	SET DOMAIN=CASE
					WHEN LEN(TRIM(DOMAIN)) > 5 and LEN(TRIM(DOMAIN)) < 7 THEN '99'+TRIM(DOMAIN)
				    ELSE TRIM(DOMAIN)
	               END
