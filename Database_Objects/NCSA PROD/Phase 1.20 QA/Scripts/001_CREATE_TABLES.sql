...
insert into [dbo].[NCSA_project_config_emails]([project_number],[active],[email_id],created_date_time,dim_entp_project_nk)
	values('99350106',1,'abhijit.kharat@mcdermott.com',@Date,29409)
insert into [dbo].[NCSA_project_config_emails]([project_number],[active],[email_id],created_date_time,dim_entp_project_nk)
	values('D7415',1,'abhijit.kharat@mcdermott.com',@Date,3197)
insert into [dbo].[NCSA_project_config_emails]([project_number],[active],[email_id],created_date_time,dim_entp_project_nk)
	values('99357972',1,'abhijit.kharat@mcdermott.com',@Date,1642)
insert into [dbo].[NCSA_project_config_emails]([project_number],[active],[email_id],created_date_time,dim_entp_project_nk)
	values('D7512',1,'abhijit.kharat@mcdermott.com',@Date,3010)
