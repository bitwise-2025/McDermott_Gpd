/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_Onshore_fact_load]    Script Date: 1/25/2023 11:54:57 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROC [dbo].[load_NCSA_fact_MCPM_Onshore_fact_load] AS
...
-----------------------------------------------------------------------------------------------------*/
	...
	SELECT
		...
		dim_ent_jde_coa_nk,
		convert(datetime,left(CutOff,19)),
		convert(float,ApprovedEACQty),
		load_date_time
		FROM [gpd].[NCSA_MCPM_Onshore]
		WHERE --isnull(convert(float,ApprovedEACQty),0) <> 0
	...
	SELECT
		...
		dim_ent_jde_coa_nk,
		convert(datetime,left(CutOff,19)),
		convert(float,ApprovedEACAmt),
		load_date_time
		FROM [gpd].[NCSA_MCPM_Onshore]
		WHERE --isnull(convert(float,ApprovedEACAmt),0) <> 0
	...
	SELECT
		...
		dim_ent_jde_coa_nk,
		convert(datetime,left(CutOff,19)),
		convert(float,ApprovedETCHrs),
		load_date_time
		FROM [gpd].[NCSA_MCPM_Onshore]
		WHERE --isnull(convert(float,ApprovedETCHrs),0) <> 0
	...
	SELECT
		...
		dim_ent_jde_coa_nk,
		convert(datetime,left(CutOff,19)),
		convert(float,ApprovedETCAmt),
		load_date_time
		FROM [gpd].[NCSA_MCPM_Onshore]
		WHERE --isnull(convert(float,ApprovedETCAmt),0) <> 0
	...
	SELECT
		...
		dim_ent_jde_coa_nk,
		convert(datetime,left(CutOff,19)),
		convert(float,ApprovedEACHrs),
		load_date_time
		FROM [gpd].[NCSA_MCPM_Onshore]
		WHERE --isnull(convert(float,ApprovedEACHrs),0) <> 0
	...
	SELECT
		...
		dim_ent_source_sk,
		dim_ent_source_nk,
		dim_ent_unit_of_measure_percentage_sk,
		dim_ent_unit_of_measure_percentage_nk,
		dim_ent_jde_coa_sk,
		dim_ent_jde_coa_nk,
		convert(datetime,left(CutOff,19)),
	...
	TRUNCATE TABLE [gpd].[NCSA_MCPM_Onshore]
