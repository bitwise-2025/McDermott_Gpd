...
ALTER TABLE [gpd].[NCSA_MCPM_Legacy]
	ADD 	[dim_ent_jde_coa_sk] [int] NULL,
		[dim_ent_jde_coa_nk] [int] NULL,
		[JDE_COA] [varchar](100) NULL;



GO

/****** Object:  Table [gpd].[reprocess_NCSA_MCPM_Onshore_Legacy]    Script Date: 8/3/2023 2:30:13 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [gpd].[reprocess_NCSA_MCPM_Onshore_Legacy]
(
