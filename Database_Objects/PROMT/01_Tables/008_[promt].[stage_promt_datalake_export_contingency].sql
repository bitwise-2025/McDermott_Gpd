CREATE TABLE [promt].[stage_promt_datalake_export_contingency]
(
	[stage_promt_datalake_export_contingency_id] [int] IDENTITY(1,1) NOT NULL,
	[ca_id]										int NOT NULL,	
 ...
 CONSTRAINT [stage_promt_datalake_export_contingency_id] PRIMARY KEY NONCLUSTERED 
	(
		[stage_promt_datalake_export_contingency_id] ASC
	) NOT ENFORCED 
)
WITH
(
