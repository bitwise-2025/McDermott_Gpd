/****** Object:  Table [yardkpi].[stage_entp_mwin_rfi_milestone]    Script Date: 5/23/2024 3:41:46 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [yardkpi].[stage_entp_mwin_rfi_milestone]
(
	[stage_entp_mwin_rfi_milestone_id] [bigint] IDENTITY(1,1) NOT NULL,
