/****** Object:  Table [dbo].[dim_entp_yardkpi_r2p_po_header]   Script Date: 11/23/2022 11:35:55 AM ******/
SET ANSI_NULLS ON
GO
...
--DROP TABLE [dbo].[dim_entp_yardkpi_r2p_po_header]

CREATE TABLE [dbo].[dim_entp_yardkpi_r2p_po_header]
(
	[dim_entp_yardkpi_r2p_po_header_sk] [bigint] IDENTITY(1,1) NOT NULL,
	[dim_entp_yardkpi_r2p_po_header_nk] [bigint] NULL,
