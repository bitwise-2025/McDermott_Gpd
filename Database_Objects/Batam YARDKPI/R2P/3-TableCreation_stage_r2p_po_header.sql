/****** Object:  Table [yardkpi].[stage_r2p_po_header]    Script Date: 11/22/2022 4:41:38 PM ******/
SET ANSI_NULLS ON
GO
...
--DROP TABLE [yardkpi].[stage_r2p_po_header]

CREATE TABLE [yardkpi].[stage_r2p_po_header]
(
	[stage_r2p_po_header_id] [bigint] IDENTITY(1,1) NOT NULL,
