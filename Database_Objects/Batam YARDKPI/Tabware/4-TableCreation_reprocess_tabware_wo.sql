/****** Object:  Table [yardkpi].[reprocess_tabware_wo]    Script Date: 11/23/2022 11:29:07 AM ******/
SET ANSI_NULLS ON
GO
...
--DROP TABLE [yardkpi].[reprocess_tabware_wo]

CREATE TABLE [yardkpi].[reprocess_tabware_wo]
(
