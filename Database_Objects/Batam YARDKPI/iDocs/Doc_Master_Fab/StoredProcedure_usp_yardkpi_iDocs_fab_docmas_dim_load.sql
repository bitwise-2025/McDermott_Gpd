/****** Object:  StoredProcedure [dbo].[usp_yardkpi_iDocs_fab_docmas_dim_load]    Script Date: 11/6/2023 12:26:12 PM ******/

DROP PROC [dbo].[usp_yardkpi_iDocs_fab_docmas_dim_load]
...
CREATE PROC [dbo].[usp_yardkpi_iDocs_fab_docmas_dim_load] AS
begin
	begin try
		...
		set @processed_count=(select count(*) from yardkpi.stage_iDocs_fab_docmaster)
		...
		if @processed_count > 0 
			begin 
				...
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_project_yardkpi_iDocs_docmas','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_ent_contract_yardkpi_iDocs_docmas','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_yardkpi_iDocs_fab_docmaster','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_yardkpi_iDocs_fab_docmaster_rev','Y','N','Y'
