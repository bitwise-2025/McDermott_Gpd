/****** Object:  StoredProcedure [dbo].[usp_yardkpi_iDocs_fab_msmaster_dim_load]    Script Date: 11/6/2023 12:33:08 PM ******/

DROP PROC [dbo].[usp_yardkpi_iDocs_fab_msmaster_dim_load]
...
CREATE PROC [dbo].[usp_yardkpi_iDocs_fab_msmaster_dim_load] AS
...
begin
	begin try
		...
		set @processed_count=(select count(*) from yardkpi.stage_iDocs_fab_msmaster)
		...
		if @processed_count > 0 
			begin 
				...
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_project_yardkpi_iDocs_msmaster','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_ent_contract_yardkpi_iDocs_msmaster','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_yardkpi_iDocs_fab_msmaster','Y','N','Y'
