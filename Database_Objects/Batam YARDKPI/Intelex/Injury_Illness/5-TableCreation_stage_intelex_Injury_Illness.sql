/****** Object:  Table [yardkpi].[stage_intelex_injury_illness]    Script Date: 11/22/2022 4:41:38 PM ******/
SET ANSI_NULLS ON
GO
...
--DROP TABLE [yardkpi].[stage_intelex_injury_illness]

CREATE TABLE [yardkpi].[stage_intelex_injury_illness]
(
	[stage_intelex_injury_illness_id] [bigint] IDENTITY(1,1) NOT NULL,
