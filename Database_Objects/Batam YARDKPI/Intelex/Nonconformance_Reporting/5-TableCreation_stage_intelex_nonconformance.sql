/****** Object:  Table [yardkpi].[stage_intelex_nonconformance]    Script Date: 11/22/2022 4:41:38 PM ******/
SET ANSI_NULLS ON
GO
...
--DROP TABLE [yardkpi].[stage_intelex_nonconformance]

CREATE TABLE [yardkpi].[stage_intelex_nonconformance]
(
	[stage_intelex_nonconformance_id] [bigint] IDENTITY(1,1) NOT NULL,
