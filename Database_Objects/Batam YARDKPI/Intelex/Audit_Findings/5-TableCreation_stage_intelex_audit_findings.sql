...
--DROP TABLE [yardkpi].[stage_intelex_audit_findings]

CREATE TABLE [yardkpi].[stage_intelex_audit_findings]
(
	[stage_intelex_audit_findings_id] [bigint] IDENTITY(1,1) NOT NULL,
