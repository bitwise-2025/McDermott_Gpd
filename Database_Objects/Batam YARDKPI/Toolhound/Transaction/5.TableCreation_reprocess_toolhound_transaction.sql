/****** Object:  Table [yardkpi].[reprocess_toolhound_transaction]    Script Date: 09-25-2023 10:20:07 AM ******/
SET ANSI_NULLS ON
GO
...
--DROP TABLE [yardkpi].[reprocess_toolhound_transaction]

CREATE TABLE [yardkpi].[reprocess_toolhound_transaction]
(
