/****** Object:  View [gpd].[Vendor_Payment_Forecast_PMR_JSON_active_v]    Script Date: 11/10/2022 11:53:29 AM ******/
SET ANSI_NULLS ON
GO
...
select [project number] + [contract number] + [Date] + CONVERT(VARCHAR,(MAX(CAST(zVersionNo AS INT)))) from [gpd].[Vendor_Payment_Forecast_PMR_JSON_v]
