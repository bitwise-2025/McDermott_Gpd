IF	OBJECT_ID('[dbo].[fact_ops_MCPM_Legacy_Offshore_progress_v]','V') IS NOT NULL
DROP VIEW [dbo].[fact_ops_MCPM_Legacy_Offshore_progress_v]
GO
IF	OBJECT_ID('[dbo].[fact_pmr_MCPM_Offshore_progress_v]','V') IS NOT NULL
DROP VIEW [dbo].[fact_pmr_MCPM_Offshore_progress_v]
GO
IF	OBJECT_ID('[dbo].[fact_pmr_MCPM_Onshore_progress_v]','V') IS NOT NULL
DROP VIEW [dbo].[fact_pmr_MCPM_Onshore_progress_v]
GO

/****** Object:  View [dbo].[fact_ops_MCPM_Legacy_Offshore_progress_v]    Script Date: 11/10/2022 2:00:39 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[fact_ops_MCPM_Legacy_Offshore_progress_v]
AS select 
...
/****** Object:  View [dbo].[fact_pmr_MCPM_Offshore_progress_v]    Script Date: 11/10/2022 2:01:15 PM ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  View [dbo].[fact_pmr_MCPM_Onshore_progress_v]    Script Date: 11/10/2022 2:01:39 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[fact_pmr_MCPM_Onshore_progress_v]
AS select  z.*,f.dim_ent_prime_nk,'GEAC-' + convert(varchar(50),z.dim_ent_jde_coa_nk) coa_key  from 
(select 
fact_entp_sk	  
,[dim_entp_function_nk]
,[dim_entp_project_nk]
