CREATE TABLE [dbo].[dim_ecmhr_geolocation_bl1]
(
	[dim_ecmhr_geolocation_bl1_sk] [int] IDENTITY(1,1) NOT NULL,
	[dim_ecmhr_geolocation_bl1_nk] [int] NOT NULL,
 ...
 CONSTRAINT [business_line_1pk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_ecmhr_geolocation_bl1_sk] ASC
	) NOT ENFORCED 
)
WITH
(
...
CREATE TABLE [dbo].[dim_ecmhr_geolocation_bl2]
(
	[dim_ecmhr_geolocation_bl2_sk] [int] IDENTITY(1,1) NOT NULL,
	[dim_ecmhr_geolocation_bl2_nk] [int] NOT NULL,
	...
	[modified_date_time] [datetime] NULL,
	[late_arrival_flag] [varchar](1) NOT NULL,
 CONSTRAINT [business_line_2pk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_ecmhr_geolocation_bl2_sk] ASC
	) NOT ENFORCED 
)
WITH
(
...
CREATE TABLE [dbo].[dim_ecmhr_geolocation_area]
(
	[dim_ecmhr_geolocation_area_sk] [int] IDENTITY(1,1) NOT NULL,
	[dim_ecmhr_geolocation_area_nk] [int] NOT NULL,
	...
	[modified_date_time] [datetime] NULL,
	[late_arrival_flag] [varchar](1) NOT NULL,
 CONSTRAINT [areapk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_ecmhr_geolocation_area_sk] ASC
	) NOT ENFORCED 
)
WITH
(
...
CREATE TABLE [dbo].[dim_ecmhr_geolocation_country]
(
	[dim_ecmhr_geolocation_country_sk] [int] IDENTITY(1,1) NOT NULL,
	[dim_ecmhr_geolocation_country_nk] [int] NOT NULL,
	...
	[modified_date_time] [datetime] NULL,
	[late_arrival_flag] [varchar](1) NOT NULL,
 CONSTRAINT [countrypk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_ecmhr_geolocation_country_sk] ASC
	) NOT ENFORCED 
)
WITH
(
...
CREATE TABLE [dbo].[dim_ecmhr_geolocation_location]
(
	[dim_ecmhr_geolocation_location_sk] [int] IDENTITY(1,1) NOT NULL,
	[dim_ecmhr_geolocation_location_nk] [int] NOT NULL,
	...
	[modified_date_time] [datetime] NULL,
	[late_arrival_flag] [varchar](1) NOT NULL,
 CONSTRAINT [locationpk] PRIMARY KEY NONCLUSTERED 
	(
		[dim_ecmhr_geolocation_location_sk] ASC
	) NOT ENFORCED 
)
WITH
(
