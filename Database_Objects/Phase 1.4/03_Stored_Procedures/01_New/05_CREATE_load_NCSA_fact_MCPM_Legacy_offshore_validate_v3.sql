/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_Legacy_Offshore_validate]    Script Date: 5/28/2022 3:06:08 AM ******/
--DROP PROCEDURE [dbo].[load_NCSA_fact_MCPM_Legacy_Offshore_validate]
--GO



/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_Legacy_Offshore_validate]    Script Date: 5/22/2022 9:03:59 PM ******/
SET ANSI_NULLS ON
GO
...
-----------------------------------------------------------------------------------------------------*/
	...
	UPDATE [gpd].[NCSA_MCPM_Legacy]
	SET office_entity=substring(ISNULL(CoA,''),6,4)
