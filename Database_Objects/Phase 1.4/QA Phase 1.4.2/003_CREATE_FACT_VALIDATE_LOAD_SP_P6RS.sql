/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_P6_resource_spread_fact_load]    Script Date: 8/4/2022 1:47:22 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROC [dbo].[load_NCSA_fact_P6_resource_spread_fact_load] AS
...
select dim_entp_function_sk,
		...
		sum(convert(float,Units)) over (partition by project,Activity_ID,resource_id, Spreadsheet_Field, period) as Units,
		row_number() over (partition by project,Activity_ID,resource_id, Spreadsheet_Field, period order by stage_p6_engr_id) as sl_no,
		load_date_time	  
...
GO
/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_P6_resource_spread_validate]    Script Date: 8/4/2022 1:47:22 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROC [dbo].[load_NCSA_fact_P6_resource_spread_validate] AS
...
--04/21/2022 : Clear the stage table of all dummy records
		...
		select distinct data_class,Spreadsheet_Field as data_sub_class into #tmp_sub_class from [gpd].[P6_resource_spread]
