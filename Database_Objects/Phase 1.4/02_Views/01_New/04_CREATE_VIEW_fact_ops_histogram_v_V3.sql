/****** Object:  View [dbo].[fact_ops_histogram_v]    Script Date: 8/4/2022 5:59:55 AM ******/
IF	OBJECT_ID('[dbo].[fact_ops_histogram_v]','V') IS NOT NULL
DROP VIEW [dbo].[fact_ops_histogram_v]
GO


/****** Object:  View [dbo].[fact_ops_histogram_v]    Script Date: 8/4/2022 5:59:56 AM ******/
SET ANSI_NULLS ON
GO
