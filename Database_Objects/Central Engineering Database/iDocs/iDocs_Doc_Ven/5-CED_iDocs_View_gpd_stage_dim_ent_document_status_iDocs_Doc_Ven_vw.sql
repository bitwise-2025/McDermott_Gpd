...
CREATE VIEW gpd.stage_dim_ent_document_status_iDocs_Doc_Ven_vw
AS select distinct
	ROW_NUMBER() over(ORDER BY Issue_State ASC) as  [stage_dim_ent_document_status_iDocs_Doc_Ven_id]
