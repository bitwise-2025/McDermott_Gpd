...
CREATE PROC [dbo].[usp_iDocs_Doc_Ven_dim_loads] AS
...
begin
	begin try
		...
		set @processed_count=(select count(*) from gpd.iDocs_Doc_Ven)
		...
		if @processed_count > 0 
			begin 
				...
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_project_iDocs_Doc_Ven','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_entp_cwp_iDocs_Doc_Ven','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_ent_document_status_iDocs_Doc_Ven','Y','N','Y'
				EXECUTE [dbo].[generic_load_dim_v2] 'dim_ent_discipline_iDocs_Doc_Ven','Y','N','Y'
