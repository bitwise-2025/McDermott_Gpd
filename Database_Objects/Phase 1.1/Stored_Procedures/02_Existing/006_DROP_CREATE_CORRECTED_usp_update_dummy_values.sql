/****** Object:  StoredProcedure [dbo].[usp_update_dummy_values]    Script Date: 11/17/2021 4:47:48 AM ******/
...
--Change Log: 11/17/2021 : Satish: Corrected the project dimension to consider only active projects in every dimension insert.
...
begin
	...
	where dim_entp_project.active=1 and dim_entp_project_nk = @dim_entp_project_nk and (select count(*) from [dbo].[dim_entp_phase] a where a.dim_entp_project_nk = [dbo].[dim_entp_project].dim_entp_project_nk and phase_code = 'ZZZ') = 0
	...
	getdate(),getdate(),'N','N/A',dim_entp_project_nk
	from [dbo].[dim_entp_project]
	where dim_entp_project.active=1 and dim_entp_project_nk = @dim_entp_project_nk and (select count(*) from [dbo].[dim_entp_work_unit] a where a.dim_entp_project_nk = [dbo].[dim_entp_project].dim_entp_project_nk and work_unit_code = 'ZZZ') = 0
	...
	where  dim_entp_project.active=1 and [dbo].[dim_entp_project].dim_entp_project_nk = @dim_entp_project_nk and  [dbo].[dim_entp_project].dim_entp_project_nk = [dim_entp_work_unit].dim_entp_project_nk
	...
	getdate(),getdate(),'N','N/A',dim_entp_project_nk
	from [dbo].[dim_entp_project]
	where dim_entp_project.active=1 and dim_entp_project_nk = @dim_entp_project_nk and (select count(*) from [dbo].[dim_entp_schedule_resource] a where a.dim_entp_project_nk = [dbo].[dim_entp_project].dim_entp_project_nk and schedule_resource_code = 'ZZZ') = 0
	...
	from [dbo].[dim_entp_project]
	where dim_entp_project.active=1 and dim_entp_project_nk = @dim_entp_project_nk and (select count(*) from [dbo].dim_entp_cwp a where a.dim_entp_project_nk = [dbo].[dim_entp_project].dim_entp_project_nk and cwp_code = 'ZZZ') = 0
	...
	where dim_entp_project.active=1 and [dbo].[dim_entp_project].dim_entp_project_nk = @dim_entp_project_nk and  [dbo].[dim_entp_project].dim_entp_project_nk = dim_entp_work_area.dim_entp_project_nk
	...
	where dim_entp_project.active=1 and [dbo].[dim_entp_project].dim_entp_project_nk = @dim_entp_project_nk and [dbo].[dim_entp_project].dim_entp_project_nk = dim_entp_activity.dim_entp_project_nk
	...
	where dim_entp_project.active=1 and  [dbo].[dim_entp_project].dim_entp_project_nk = @dim_entp_project_nk and [dbo].[dim_entp_project].dim_entp_project_nk = dim_entp_iwp.dim_entp_project_nk
	...
	from [dbo].[dim_entp_project]
	where dim_entp_project.active=1 and [dbo].[dim_entp_project].dim_entp_project_nk = @dim_entp_project_nk and (select count(*) from [dbo].dim_entp_roc a where a.dim_entp_project_nk = [dbo].[dim_entp_project].dim_entp_project_nk and roc_code = 'ZZZ') = 0
