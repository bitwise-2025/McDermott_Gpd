/****** Object:  StoredProcedure [dbo].[load_NCSA_fact_MCPM_Onshore_validate]    Script Date: 11/8/2021 3:21:54 AM ******/
DROP PROCEDURE [dbo].[load_NCSA_fact_MCPM_Onshore_validate]
GO
...
CREATE PROC [dbo].[load_NCSA_fact_MCPM_Onshore_validate] @projectId [varchar](100) AS
BEGIN
