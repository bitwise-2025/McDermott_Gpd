Alter VIEW [gpd].[Cost_Code_Exception_Offshore_PMR_JSON_active_v]
...
v.[OME PSR Level 1] as [OME PSR Level 1 Code],
v.[OME PSR Level 1],
v.[OME PSR Level 2] as [OME PSR Level 2 Code],
v.[OME PSR Level 2],
v.[OME PSR Level 3] as [OME PSR Level 3 Code],
v.[OME PSR Level 3],
v.[OME PSR Level 4] as [OME PSR Level 4 Code],
v.[OME PSR Level 4],
v.[zCreatedDateTime],
v.[zSourceFileName],
v.[zVersionNo]  
