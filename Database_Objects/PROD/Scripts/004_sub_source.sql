...
begin
	select @next_val = isnull(max(dim_ent_sub_source_nk),0) + 1 from dim_ent_sub_source
	insert into dim_ent_sub_source(dim_ent_sub_source_nk,start_date,end_date,hash_code,active,created_date_time,modified_date_time,late_arrival_flag,dim_ent_source_nk,source_name,sub_source_name)
	 values (@next_val,'2000-01-01 00:00:00.000','2050-12-30 00:00:00.000','hŒ„U+šbS3xÑ ”z','1','2020-08-20 00:00:00.000',NULL,'N','2','SYSTEM','MCPM Progress Items')
end
...
begin
	select @next_val = isnull(max(dim_ent_sub_source_nk),0) + 1 from dim_ent_sub_source
	insert into dim_ent_sub_source(dim_ent_sub_source_nk,start_date,end_date,hash_code,active,created_date_time,modified_date_time,late_arrival_flag,dim_ent_source_nk,source_name,sub_source_name)
	 values (@next_val,'1900-01-01 00:00:00.000','2050-12-31 00:00:00.000','@ aäÛLqˆë“Î¤þ3‚','1','2020-08-20 00:00:00.000',NULL,'N','2','System','Job Costing')
end
...
begin
	select @next_val = isnull(max(dim_ent_sub_source_nk),0) + 1 from dim_ent_sub_source
	insert into dim_ent_sub_source(dim_ent_sub_source_nk,start_date,end_date,hash_code,active,created_date_time,modified_date_time,late_arrival_flag,dim_ent_source_nk,source_name,sub_source_name)
	 values (@next_val,'2000-01-01 00:00:00.000','2050-12-30 00:00:00.000','YÞCmZ.zˆv•)','1','2020-08-20 19:10:01.503',NULL,'N','2','SYSTEM','MCPM Onshore')
end
...
begin
	select @next_val = isnull(max(dim_ent_sub_source_nk),0) + 1 from dim_ent_sub_source
	insert into dim_ent_sub_source(dim_ent_sub_source_nk,start_date,end_date,hash_code,active,created_date_time,modified_date_time,late_arrival_flag,dim_ent_source_nk,source_name,sub_source_name)
	 values (@next_val,'2000-01-01 00:00:00.000','2050-12-30 00:00:00.000','fä¬q½™«ÝðÜwA€ˆ','1','2020-08-20 00:00:00.000',NULL,'N','1','MANUAL','EXCEL')
end
...
begin
	select @next_val = isnull(max(dim_ent_sub_source_nk),0) + 1 from dim_ent_sub_source
	insert into dim_ent_sub_source(dim_ent_sub_source_nk,start_date,end_date,hash_code,active,created_date_time,modified_date_time,late_arrival_flag,dim_ent_source_nk,source_name,sub_source_name)
	 values (@next_val,'2000-01-01 00:00:00.000','2050-12-30 00:00:00.000','˜~ûT£‰¯íýëlƒÏ','1','2020-08-20 00:00:00.000',NULL,'N','2','SYSTEM','P6')
end
