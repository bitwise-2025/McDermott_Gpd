...
begin
	select @next_val = isnull(max(dim_ent_function_nk),0) + 1 from dim_ent_function
	insert into dim_ent_function(dim_ent_function_nk,start_date,end_date,hash_code,active,created_date_time,modified_date_time,late_arrival_flag,function_code,function_name)
	 values (@next_val,'2000-01-01 00:00:00.000','2050-12-31 00:00:00.000','7¶ i>Eêœ]“ß.','1','2021-08-20 00:00:00.000',NULL,'N','CMN','Commissioning')
end
...
begin
	select @next_val = isnull(max(dim_ent_function_nk),0) + 1 from dim_ent_function
	insert into dim_ent_function(dim_ent_function_nk,start_date,end_date,hash_code,active,created_date_time,modified_date_time,late_arrival_flag,function_code,function_name)
	 values (@next_val,'2000-01-01 00:00:00.000','2050-01-01 00:00:00.000','¶gsÈ¹øŒ©˜$Ë¾ÓâW','1','2021-08-20 18:41:26.777',NULL,'N','OTH','Others')
end
