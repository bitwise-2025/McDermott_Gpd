/****** Object:  View [dbo].[fact_ops_as_rows_v]    Script Date: 7/20/2021 12:19:33 AM ******/
DROP VIEW [dbo].[fact_ops_as_rows_v]
GO
/****** Object:  View [dbo].[fact_ent_time_ets_v]    Script Date: 7/20/2021 12:19:33 AM ******/
DROP VIEW [dbo].[fact_ent_time_ets_v]
GO
/****** Object:  View [dbo].[fact_ent_time_ets_v]    Script Date: 7/20/2021 12:19:33 AM ******/
SET ANSI_NULLS ON
GO
...
GO
CREATE VIEW [dbo].[fact_ent_time_ets_v]
AS SELECT
	a.[created_date_time] ,
	a.[dim_ent_source_sk] ,
	a.[dim_ent_source_nk] ,
	...
	a.[dim_ent_timesheet_date_sk] ,
	a.[dim_ent_employee_sk] ,
	a.[dim_ent_employee_nk] ,
	a.[dim_ent_equipment_sk] ,
	a.[dim_ent_equipment_nk] ,
	[dim_ent_timesheet_approver_date] ,
	a.[dim_ent_contract_sk] ,
	a.[dim_ent_contract_nk] ,
	[dim_ent_extracted_date] ,
	[dim_ent_pay_type_sk] ,
	[dim_ent_pay_type_nk] ,
	a.[dim_ent_combined_coa_sk] ,
	a.[dim_ent_combined_coa_nk] ,
	[dim_ent_geac_coa_sk] ,
	[dim_ent_geac_coa_nk] ,
	[dim_ent_jde_coa_sk] ,
	[dim_ent_jde_coa_nk] ,
	[dim_ent_unit_of_measure_sk] ,
...
FROM 
Fact_ent_time a,
[dbo].[dim_ent_sub_source_active_v] b,
timesheet_v T
WHERE a.dim_ent_sub_source_nk = b.dim_ent_sub_source_nk 
and a.fact_ent_time_sk=T.fact_ent_time_sk
and b.sub_source_name = 'Timeworks';
GO
/****** Object:  View [dbo].[fact_ops_as_rows_v]    Script Date: 7/20/2021 12:19:33 AM ******/
SET ANSI_NULLS ON
GO
