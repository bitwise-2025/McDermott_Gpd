...
/****** Object:  StoredProcedure [dbo].[generic_row_level_security_backup]    Script Date: 8/23/2023 11:12:45 AM ******/
...
CREATE PROC [dbo].[generic_row_level_security_backup] @p_sec_sa_description [varchar](120),@p_fact_table_name [varchar](120),@p_fact_table_sk_column_name [varchar](120),@p_hash_table_required [varchar](1) AS
