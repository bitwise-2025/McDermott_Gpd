...
SELECT * INTO [dbo].[dim_entp_work_unit_bkp_01112022]
FROM [dbo].[dim_entp_work_unit] --909 records

SELECT * INTO [dbo].[dim_entp_work_area_bkp_01112022]
FROM [dbo].[dim_entp_work_area] --1141 records
...
GO
/****** Object:  Table [dbo].[dim_entp_work_unit]    Script Date: 1/11/2022 12:29:24 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dim_entp_work_unit]') AND type in (N'U'))
DROP TABLE [dbo].[dim_entp_work_unit]
GO
...
(
	...
	[work_area_code] [varchar](5) NOT NULL,
	...
	[work_area_name] [varchar](120) NULL,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[dim_entp_work_unit]
(
	[dim_entp_work_unit_sk] [int] IDENTITY(1,1) NOT NULL,
	[dim_entp_work_unit_nk] [int] NOT NULL,
	...
	[modified_date_time] [datetime] NULL,
	[late_arrival_flag] [varchar](1) NOT NULL,
	[work_unit_name] [varchar](100) NULL,
	[dim_entp_project_nk] [int] NOT NULL,
	[project_number] [varchar](120) NULL,
 CONSTRAINT [Cnstr_27e94acc1e814b43a4d7bc4966732772] PRIMARY KEY NONCLUSTERED 
	(
		[dim_entp_work_unit_sk] ASC
	) NOT ENFORCED 
)
WITH
(
...
GO
/****** Object:  Index [indGNKA]    Script Date: 1/11/2022 12:29:24 AM ******/
CREATE NONCLUSTERED INDEX [indGNKA] ON [dbo].[dim_entp_work_unit]
(
	[dim_entp_work_unit_nk] ASC,
	[active] ASC
)WITH (DROP_EXISTING = OFF)
GO
/****** Object:  Index [indGNKSE]    Script Date: 1/11/2022 12:29:24 AM ******/
CREATE NONCLUSTERED INDEX [indGNKSE] ON [dbo].[dim_entp_work_unit]
(
	[dim_entp_work_unit_nk] ASC,
	[start_date] ASC,
	[end_date] ASC
...
GO
/****** Object:  Index [indNK]    Script Date: 1/11/2022 12:29:24 AM ******/
CREATE NONCLUSTERED INDEX [indNK] ON [dbo].[dim_entp_work_unit]
(
	[work_unit_code] ASC
)WITH (DROP_EXISTING = OFF)
GO
...
GO
/****** Object:  Index [indNKA]    Script Date: 1/11/2022 12:29:24 AM ******/
CREATE NONCLUSTERED INDEX [indNKA] ON [dbo].[dim_entp_work_unit]
(
	[work_unit_code] ASC,
	[active] ASC
)WITH (DROP_EXISTING = OFF)
...
GO
/****** Object:  Index [indNKSE]    Script Date: 1/11/2022 12:29:24 AM ******/
CREATE NONCLUSTERED INDEX [indNKSE] ON [dbo].[dim_entp_work_unit]
(
	[work_unit_code] ASC,
	[start_date] ASC,
	[end_date] ASC
...
GO
/****** Object:  Index [indRK1]    Script Date: 1/11/2022 12:29:24 AM ******/
CREATE NONCLUSTERED INDEX [indRK1] ON [dbo].[dim_entp_work_unit]
(
	[dim_entp_project_nk] ASC
)WITH (DROP_EXISTING = OFF)
GO
/****** Object:  Index [indSK]    Script Date: 1/11/2022 12:29:24 AM ******/
CREATE NONCLUSTERED INDEX [indSK] ON [dbo].[dim_entp_work_unit]
(
	[dim_entp_work_unit_sk] ASC
)WITH (DROP_EXISTING = OFF)
GO
...
--Step 3] Reload the data from the UNIT backup table into new DIM tables

SET IDENTITY_INSERT [dbo].[dim_entp_work_unit] ON;  
GO  
...
([dim_entp_work_unit_sk],
       ...
       [dim_entp_project_nk],
       [project_number])
select * from [dbo].[dim_entp_work_unit_bkp_01112022]

Go


SET IDENTITY_INSERT [dbo].[dim_entp_work_unit] OFF;  
GO  
...
select * from [dbo].[dim_entp_work_area_bkp_01112022]
