/* Create new reprocess table [gpd].[reprocess_dim_ent_geac_coa_MCPM_Off] */

/****** Object:  Table [gpd].[reprocess_dim_ent_geac_coa_MCPM_Off]    Script Date: 3/4/2022 3:21:28 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [gpd].[reprocess_dim_ent_geac_coa_MCPM_Off]
(
